...
**YOU ARE IN: `emoji_hero/polecats/nitro/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/emoji_hero/` (rig root) or other directories
...
**Your mail address:** `emoji_hero/polecats/nitro`
**Your rig:** emoji_hero
**Your Witness:** `emoji_hero/witness`
...
| Ask Witness for help | `gt mail send emoji_hero/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`emoji_hero/witness`) when:
...
```bash
gt mail send emoji_hero/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
